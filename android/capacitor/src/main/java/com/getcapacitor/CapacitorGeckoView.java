...
public class CapacitorGeckoView extends GeckoView {
    private BaseInputConnection capInputConnection;

    public CapacitorGeckoView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        if (event.getKeyCode() == KeyEvent.KEYCODE_BACK) {
            return false; // Do not let GeckoView handle the Back button!
        }
